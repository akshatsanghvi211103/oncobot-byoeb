...
class User(BaseModel):
    user_id: Optional[str] = Field(None, description="Unique identifier for the user (patient_id)", example="12345")
    user_name: Optional[str] = Field(None, description="Full name of the user", example="John Doe")
    ...
    patient_details: Optional[Dict[str, Any]] = Field(default_factory=dict, description="Additional patient information like Date of Birth, Gender, etc.")
