...
def validate_regular_message(original_message):
    ...
    # Early detection of Qikchat messages to avoid validation errors
    if isinstance(original_message, dict) and "event" in original_message:
        # This is a Qikchat webhook, not a WhatsApp message
        print("WhatsApp validator: Detected Qikchat message structure, skipping")
        return False
